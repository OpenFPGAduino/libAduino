...
#define __IO_CALC_ADDRESS_NATIVE(base, offset) (base + offset)
#define IORD(base, offset)  *(((volatile int*)base + offset))
#define IOWR(base, offset, data) *(((volatile int*)base + offset)) = data;
