...
#define STEP_MOTOR_5        QSYS_ADDRESS_TO_LINUX_ADDRESS(0x10000900)
#define STEP_MOTOR_6        QSYS_ADDRESS_TO_LINUX_ADDRESS(0x10000920)
#define STEP_MOTOR_7        QSYS_ADDRESS_TO_LINUX_ADDRESS(0x10000940)
#define STEP_MOTOR_8        QSYS_ADDRESS_TO_LINUX_ADDRESS(0x10000960)

#define POSITITON_SENSNOR_0 QSYS_ADDRESS_TO_LINUX_ADDRESS(0x10000980)
#define POSITITON_SENSNOR_1 QSYS_ADDRESS_TO_LINUX_ADDRESS(0x100009a0)
#define POSITITON_SENSNOR_2 QSYS_ADDRESS_TO_LINUX_ADDRESS(0x100009c0)
#define POSITITON_SENSNOR_3 QSYS_ADDRESS_TO_LINUX_ADDRESS(0x100009e0)
#define POSITITON_SENSNOR_4 QSYS_ADDRESS_TO_LINUX_ADDRESS(0x10000a00)
#define POSITITON_SENSNOR_5 QSYS_ADDRESS_TO_LINUX_ADDRESS(0x10000a20)
#define POSITITON_SENSNOR_6 QSYS_ADDRESS_TO_LINUX_ADDRESS(0x10000a40)
#define POSITITON_SENSNOR_7 QSYS_ADDRESS_TO_LINUX_ADDRESS(0x10000a60)
#define POSITITON_SENSNOR_8 QSYS_ADDRESS_TO_LINUX_ADDRESS(0x10000a80)
...
#define BRUSH_MOTOR_4       QSYS_ADDRESS_TO_LINUX_ADDRESS(0x10000340)
#define BRUSH_MOTOR_5       QSYS_ADDRESS_TO_LINUX_ADDRESS(0x10000360)
#define BRUSH_MOTOR_6       QSYS_ADDRESS_TO_LINUX_ADDRESS(0x10000ac0)
#define BRUSH_MOTOR_7       QSYS_ADDRESS_TO_LINUX_ADDRESS(0x10000ae0)
#define BRUSH_MOTOR_8       QSYS_ADDRESS_TO_LINUX_ADDRESS(0x10000aa0)

#define FAN_MOTOR_0         QSYS_ADDRESS_TO_LINUX_ADDRESS(0x10000800)
#define FAN_MOTOR_1         QSYS_ADDRESS_TO_LINUX_ADDRESS(0x10000820)
#define FAN_MOTOR_2         QSYS_ADDRESS_TO_LINUX_ADDRESS(0x10000840)
#define FAN_MOTOR_3         QSYS_ADDRESS_TO_LINUX_ADDRESS(0x10000860)
#define FAN_MOTOR_4         QSYS_ADDRESS_TO_LINUX_ADDRESS(0x10000880)
#define FAN_MOTOR_5         QSYS_ADDRESS_TO_LINUX_ADDRESS(0x100008a0)
#define FAN_MOTOR_6         QSYS_ADDRESS_TO_LINUX_ADDRESS(0x100008c0)
#define FAN_MOTOR_7         QSYS_ADDRESS_TO_LINUX_ADDRESS(0x100008e0)

#define SUBDIVISION_STEP_MOTOR_0  QSYS_ADDRESS_TO_LINUX_ADDRESS(0x10000b00)
